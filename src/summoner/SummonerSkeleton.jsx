  ...
  return (
    <div className='w-dvw animate-pulse'>
      <div className='flex relative mx-6 my-4'>
        <div className='absolute rounded bg-slate-600 size-7 tablet:size-8 laptop:hidden' />
      ...
      <div className='mt-[2.4rem] laptop:mt-11'>
        ...
        <div className='grid laptop:grid-cols-10 laptop:gap-3 laptop:mt-4 laptop:ml-24'>
          <div className='laptop:col-span-3 mx-6 laptop:mx-0 my-2.5 laptop:my-1.5 space-y-2.5'>
            {[...Array(2)].map(() => (
              <div className='flex justify-between items-center bg-slate-600 rounded-lg h-[2.12rem] p-2.5'>
          ...
          <div className='laptop:col-span-7 rounded laptop:mx-2 laptop:mr-8 mt-1.5 mb-4 space-y-2.5'>
            {[...Array(20)].map((_, i) => (
              <div className='flex flex-col bg-slate-600 rounded mx-6 laptop:mx-0 pl-3 pr-2 py-2 gap-y-1.5 animate-pulse' style={{'animationDelay': `${100 * i}ms`}}>
                  ...
                  <div className='flex flex-col'>
                    <div className='flex'>
                      ...
                      <div className='flex flex-col justify-between ml-3 h-full gap-y-2'>
                        {[...Array(2)].map(() => (
                          <div className='bg-slate-700 rounded w-10 tablet:w-14 h-1/2' />
                        ))}
                      </div>
                    </div>
                  ...
                  <div className='flex tablet:hidden'>
                    <div className='flex flex-col justify-between h-full gap-y-2'>
                      ...
                      <div className='flex justify-between h-1/2'>
                        {[...Array(2)].map(() => (
                          <div className='bg-slate-700 rounded w-12' />
                        ))}
                      </div>
                    </div>
                  </div>
                  {[...Array(2)].map(() => (
                    <div className='hidden tablet:flex flex-col gap-y-2.5'>
                      {[...Array(3)].map(() => (
                        <div className='bg-slate-700 rounded w-20 h-4' />
                      ))}
                    </div>
