function AdvancedMatch({teamStats, isMyTeam, myPlayerStats, backgroundColor, region}) {
  ...
  return (
    <div className={`flex flex-col ${!isMyTeam && 'rounded-b'} ${backgroundColor}`}>
        ...
        <div className={`flex px-1 ${isMyTeam && player.name === myPlayerStats.name && getMyBackgroundColor()}`}>
          <div className='relative size-9 tablet:size-14'>
            ...
            <span className='flex items-center justify-center rounded-full size-[0.8rem] p-1 ml-0.5 mb-0.5 absolute bottom-0 left-0
              bg-slate-400 font-semibold text-[10px] text-slate-900'
            >
              {player.level}
            </span>
          </div>
          ...
          <div className='flex flex-col ml-1'> 
            ...
            <div className='flex tablet:hidden items-center mt-1 gap-x-0.5 text-[10px] text-slate-900'>
          ...
          <div className='flex flex-col ml-auto mt-0.5'>
            ...
            <div className='flex mt-0.5 gap-x-1 text-[10px]'>
              <div className='flex gap-x-0.5'>
